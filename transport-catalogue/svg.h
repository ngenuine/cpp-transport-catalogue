...
//  Вспомогательная структура, котоая хранит в себе контекст для вывода SVG-документа с отступами.
//  Хранит ссылку на поток вывода, текущее значение отступа и шаг отступа при выводе элемента
